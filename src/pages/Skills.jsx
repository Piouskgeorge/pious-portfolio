...
const skills = [
  {
    ...
    items: [
      'Penetration Testing', 'Kali Linux', 'Metasploit', 'Nmap', 'Hydra', 'SQLMap', 'Netcat', 'Burp Suite', 'Postman'
    ]
  },
  {
    category: 'Full Stack & Web',
    items: [
      'MERN Stack (MongoDB, Express.js, React.js, Node.js)', 'HTML', 'CSS', 'JavaScript', 'Python'
    ]
  },
  {
    category: 'DevOps & Scripting',
    items: [
      'Git', 'GitHub', 'Nginx', 'MySQL', 'Bash Scripting'
    ]
  },
  {
    category: 'Virtualization & OS',
    items: [
      'VMware', 'VirtualBox', 'REST APIs', 'Windows', 'Linux'
    ]
  },
  {
    category: 'Emerging Tech & Hardware',
    items: [
      'Model Context Protocol (MCP)', 'Raspberry Pi 4', 'NVIDIA Jetson Nano'
    ]
  }
];
      ...
      >
        ...
        >
          <div className="glass-card p-6 sm:p-8 rounded-2xl shadow-xl">
            ...
            <motion.a
              href="https://github.com/Piouskgeorge?tab=repositories"
              target="_blank"
