        ...
        <div className="responsive-container">
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4 sm:space-y-6 lg:space-y-8">
              ...
              >
                {' '}
                <span className="text-gradient">Pious K George</span>
              </motion.h1>
            ...
            >
              <div className="relative w-full max-w-sm sm:max-w-lg">
                <motion.div
                  ...
                  animate="animate"
                  className="terminal-card p-4 sm:p-6 rounded-2xl shadow-2xl border border-accent-red/30"
                >
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center justify-between mb-4 sm:mb-6">
                      ...
                      <span className="text-gray-400 font-mono text-sm sm:text-base">terminal</span>
                    </div>
                    ...
                    <div className="space-y-3 sm:space-y-4 font-mono text-sm sm:text-base">
                      ...
                      <div className="text-gray-300 ml-4">piouskgeorge</div>
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-accent-red">$</span>
                        <span className="text-white">./start_project.sh</span>
                      </div>
                      <div className="text-gray-300 ml-4">
                        <span className="text-green-400"></span> I need to be a part of real time project 
                      </div>
                    </div>
