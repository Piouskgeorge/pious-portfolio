...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Piouskgeorge?tab=repositories',
      icon: Github,
      ariaLabel: 'Visit GitHub profile'
    },
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/piouskgeorge',
      icon: Linkedin,
      ariaLabel: 'Visit LinkedIn profile'
    },
    {
      name: 'Email',
      url: 'mailto:piouskgeorge@gmail.com',
      icon: Mail,
            ...
            >
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-accent-red rounded-lg flex items-center justify-center">
                  <span className="text-white font-bold text-sm sm:text-base">PK</span>
                </div>
              ...
              <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
                Cybersecurity expert and AI developer passionate about building secure, intelligent applications.
              </p>
            </motion.div>
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
              <p className="text-gray-400 text-sm sm:text-base text-center sm:text-left">
                © {currentYear} Pious K George. All rights reserved.
              </p>
